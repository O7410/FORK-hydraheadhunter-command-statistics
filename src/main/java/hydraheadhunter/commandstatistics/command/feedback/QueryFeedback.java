...
public class QueryFeedback {
     private static final String DEFAULT = "commandstatistics.feedback.query.default";

     public  static <T> void provideFeedback (ServerCommandSource source, ServerPlayerEntity player, StatType<T> statType, T statSpecific, int statValue){
