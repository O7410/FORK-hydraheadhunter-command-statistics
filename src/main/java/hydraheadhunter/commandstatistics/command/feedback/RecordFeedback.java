...
public class RecordFeedback {
     private static final String DEFAULT = "commandstatistics.feedback.record.default";

     public  static <T> void provideFeedback (ServerCommandSource source, ServerPlayerEntity player, StatType<T> statType, T statSpecific, int statValue, ScoreboardObjective objective){
          ...
          source.sendFeedback(() -> stringifiedTranslatable( formatKey, playerName, statTypeText, statSpecificText, statValueText, objectiveText ), false );
     }
