...
public class ReduceFeedback {
     private static final String DEFAULT = "commandstatistics.feedback.reduce.default";

     public  static <T> void provideFeedback (ServerCommandSource source, ServerPlayerEntity player, StatType<T> statType, T statSpecific, int statValue, int amount, int statValueNext){
          ...
          Text nextValueText     = Text.literal( String.valueOf(statValueNext        ));
     ...
     public  static <T> void provideFeedback (ServerCommandSource source, ServerPlayerEntity player, StatType<T> statType, T statSpecific, int statValue, int amount, int statValueNext, ScoreboardObjective objective){
